          ...
          >
            ...
            {submitStatus === "success" && (
              <div className="mb-6 p-4 bg-green-50 rounded-xl flex items-center gap-3">
                ...
                <p className="text-green-700">Message sent! We'll respond soon.</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="w-full py-4 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-2xl transition-all disabled:opacity-60"
              >
